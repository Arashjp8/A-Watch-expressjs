...
function Navbar({ user }: NavbarProps) {
  ...
  return (
    <nav className="flex flex-row justify-between items-center w-full h-[80px] p-4 bg-slate-900/80 dark:bg-slate-800 text-slate-900">
      <div className="flex flex-row space-x-12 items-center">
        <a
          onClick={() => navigate("/")}
          className="text-2xl hover:cursor-pointer font-extrabold text-teal-500"
        >
          MovieMerge
        </a>
      </div>
