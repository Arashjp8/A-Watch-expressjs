...
function MovieCardGrid() {
  ...
  return (
    <div
      className={
        "p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 grid-rows-4 gap-4 w-full dark:text-slate-300 text-gray-600"
      }
    >
      {movies?.results.map((movie: Movie) => (
        ...
        >
          <img
            ...
            loading={"lazy"}
            className={
              "w-[full] h-[200px] object-contain sm:h-[420px] md:w-full md:h-[432px] lg:w-32 lg:h-48 rounded-md lg:rounded-l-md"
            }
          />
          <div
            className={
